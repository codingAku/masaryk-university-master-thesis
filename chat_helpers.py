...
def initialize_persona_session():
    ...
    system_prompt = (
        ...
        f"Use the transcript where you can find stakeholder style of talking. Mimic it. previous meetings provide additional context for your persona. In the transcript, look for the answers of the person you are by name. You must pay attention to the information and also the way of speaking for the person, you can use the information in the transcripts and answer like the persona: {transcripts_text}"
